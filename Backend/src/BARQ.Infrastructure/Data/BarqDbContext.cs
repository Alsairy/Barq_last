...
namespace BARQ.Infrastructure.Data
{
        ...
        Microsoft.AspNetCore.Identity.IdentityUserToken<Guid>>
    {
        ...
        private void ConfigureIndexes(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Language>()
                .HasIndex(l => new { l.TenantId, l.IsActive });
            ...
            modelBuilder.Entity<Translation>()
                .HasIndex(t => new { t.TenantId, t.Category, t.Status });

            modelBuilder.Entity<UserLanguagePreference>()
                .HasIndex(ulp => new { ulp.UserId, ulp.LanguageId })
                .IsUnique();
            ...
            modelBuilder.Entity<AccessibilityAudit>()
                .HasIndex(aa => new { aa.AuditedBy, aa.AuditedAt });
